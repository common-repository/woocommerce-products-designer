...
function wpd_built_with(){
    ...
    <div class="wpc-free-built-with">
        <a target="_blank" href="https://orionorigin.com/product/woocommerce-product-designer?utm_source=<?php echo $siteurl;?>&utm_medium=built%20with&utm_campaign=Ouidah%20-%20Built%20with"><?php _e('Built with Ouidah', 'wpd'); ?></a>
    </div>
        <?php
}
 ...
 * @return string|bool
 */
function wpd_get_woocommerce_version() {
...
/**
 * Get woocomerce product.
 *
 * @param int $product_id The product id or variation id.
 * @return array|object|bool The product data.
 */
function wpd_get_product( $product_id ) {
    $product = false;
    // Check if woocommerce is active.
    if ( ! wpd_get_woocommerce_version() == null ) {
